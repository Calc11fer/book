...
function product_8_detect() {
    if (product_8.getAttribute("src") === "/icons/cart_bt.png") {
        addProduct_8();
    } else {
        removeProduct_8();
    }
...
function addProduct_8() {
    ...
    document.getElementById("subtotalPrice").innerHTML = subtotalPrice.toFixed(2);
    product_8_cart.src = "/icons/cart_bt_clicked.png";
    addedToCart.style.backgroundColor = "#0460FB";
...
function removeProduct_8() {
    ...
    subtotalPrice -= parseFloat(books_price[0].innerHTML.slice(1));
    document.getElementById("subtotalPrice").innerHTML = subtotalPrice.toFixed(2);
    product_8_cart.src = "/icons/cart_bt.png";
    addedToCart.style.backgroundColor = "white";
    addedToCart.style.color = "#0460FB";
